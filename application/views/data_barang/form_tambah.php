...
<div class="col-md-8">
    ...
    <div class="form-group row">
     ...
     <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control form-control-sm <?= (form_error('jenis')) ? 'is-invalid' : ''; ?>" id="jenis" name="jenis" placeholder="Jenis" value="<?= (set_value('jenis')) ? set_value('jenis') : $barang->jenis; ?>">
            <div class="invalid-feedback">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control form-control-sm uang <?= (form_error('harga')) ? 'is-invalid' : ''; ?>" id="stok" name="stok" placeholder="Stok" value="<?= set_value('stok'); ?>">
            <div class="invalid-feedback">
     ...
     <div class="form-group row">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control form-control-sm uang <?= (form_error('harga_beli')) ? 'is-invalid' : ''; ?>" id="harga_beli" name="harga_beli" placeholder="Harga Beli" value="<?= set_value('harga_beli'); ?>">
            <div class="invalid-feedback">
                <?= form_error('harga_beli', '<p class="error-message">', '</p>'); ?>
            </div>
        </div>
    </div>
