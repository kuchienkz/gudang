...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-truck"></i> Tambah Data Costomer</h4>
    </div>
</div>
<hr class="mt-0" />
<?= form_open(); ?>
<div class="col-md-8">
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control form-control-sm <?= (form_error('nama_costomer')) ? 'is-invalid' : ''; ?>" id="nama_costomer" required autofocus name="nama_costomer" placeholder="Nama Costomer" value="<?= set_value('nama_costomer'); ?>">
